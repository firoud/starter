...
add_filter( 'cmb_meta_boxes', 'firoud_add_metaboxes' );

function firoud_add_metaboxes( array $meta_boxes ) {
	...
	$meta_boxes['slide_metabox'] = array(
		...
		'fields'     => array(
			array(
				'name' => __( 'Text', 'firoud' ),
				'id'   => $prefix . 'slide_url_text',
				'type' => 'text',
			),		
			array(
				'name' => __( 'Link', 'firoud' ),
				'id'   => $prefix . 'slide_url_link',
				'type' => 'text_url',
			),
			array(
				'name' => __( 'Target', 'firoud' ),
				'id'   => $prefix . 'slide_url_target',
				'type' => 'select',
				'options' => array(
				    '' => '',
					'_blank' => '_blank',
